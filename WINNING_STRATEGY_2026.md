...
NASA also publishes machine-importable spreadsheets for:
- lunar objective mapping;
- Mars objective mapping;
- architecture-driven technology gaps;
- architecture-driven data gaps.

Next data milestone: ingest the official spreadsheets directly and replace the manually curated Revision C snapshot with a reproducible transformation script plus hashes/source metadata.
